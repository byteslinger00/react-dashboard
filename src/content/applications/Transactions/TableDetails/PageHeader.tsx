...
function PageHeader(props: { userID: string, userEmail:string, userName: string, balance: number }) {
  return (
    <Box
      display="flex"
    ...
    >
      <Grid container spacing={2}>
        ...
        <Grid item sm={5} sx={{display:"flex", alignItems:"right"}}>
          <Grid container spacing={2} justifyContent={"right"}>
            <Grid item sm={12} md={6} textAlign={"right"}>
              <EditUserInfo userID={props.userID} balance={props.balance}/>
            </Grid>
            {/* <Grid item sm={12} md={6} textAlign={"right"}>
              <EditUserCredit userID={props.userID} />
            </Grid> */}
          </Grid>
        </Grid>
